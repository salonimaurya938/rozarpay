...
<h1>Product Order  <span class="shop-green">History</span></h1>
</div><!--/end container-->
</div>
<!--=== End Breadcrumbs v4 ===-->
<!--=== Registre ===-->
...
<span class="caption-subject bold uppercase"> Product Order History</span>
</div>
<div class="tool"> </div>
</div>
...
$i = 1;
$ddaa = $mysqli->query("SELECT id,name,email,pone,address,pmode,amount_paid,products,time_date,username, status,cmordptm,prduct_trx  FROM orders WHERE username='".$user."' AND status='1'OR status='2' ORDER BY id DESC");
