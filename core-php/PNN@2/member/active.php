...
$res = $mysqli->query("UPDATE users SET fname='".$firstname."', lname='".$lastname."', address='".$address."', city='".$city."', postcode='".$post."',trx_recipt='".$folder."', country='".$country."', mobile='".$mobile."', email='".$email."' WHERE mid='".$uid."'");
...
$ggvn=$mysqli->query("SELECT fname, lname, email, mobile, address, city, postcode, country,trx_recipt FROM users WHERE mid='".$uid."'");
