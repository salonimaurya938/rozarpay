...
<span class="caption-subject bold uppercase"> My Tickets</span>
        <a href="<?php echo $baseurl; ?>/OpenTicket.php" class="btn btn-success btn-md">Open New Ticket</a>
</div>
<div class="tool"> </div>
</div>
...
$i = 1;
$ddaa = $mysqli->query("SELECT tid, subject, tm, status FROM ticket_main WHERE usid='".$uid."' ORDER BY id DESC");
