...
$cv=$mysqli->query("SELECT lbv, rbv FROM member_bv WHERE mid='".$uid."'");
$cbv=$cv->fetch_array(MYSQLI_BOTH);
?>
...
$bmm=$mysqli->query("SELECT lpaid, rpaid, lfree, rfree FROM member_below WHERE mid='".$uid."'");
$bmmbr=$bmm->fetch_array(MYSQLI_BOTH);
...
<?php 
//$cbv = mysql_fetch_array(mysql_query("SELECT lbv, rbv FROM member_bv WHERE mid='".$uid."'"));
$cb=$mysqli->query("SELECT lbv, rbv FROM member_bv WHERE mid='".$uid."'");
