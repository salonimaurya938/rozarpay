...
//$general = mysql_fetch_array(mysql_query("SELECT sitetitle, policy FROM general_setting WHERE id='1'"));
$gen=$mysqli->query("SELECT sitetitle, policy FROM general_setting WHERE id='1'");
...
<h1>Privacy <span class="shop-green">Policy</span></h1>
</div><!--/end container-->
</div>
<!--=== End Breadcrumbs v4 ===-->
